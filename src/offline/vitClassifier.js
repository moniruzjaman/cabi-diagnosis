...
const LABEL_TABLE = [
  { idx: 0,  raw: 'Corn___Common_Rust',     cropEn: 'Corn',   cropBn: 'ভুট্টা',  diseaseEn: 'Common Rust',        diseaseBn: 'সাধারণ মরিচা',     isHealthy: false, category: 'fungal'   },
  { idx: 1,  raw: 'Corn___Gray_Leaf_Spot',  cropEn: 'Corn',   cropBn: 'ভুট্টা',  diseaseEn: 'Gray Leaf Spot',     diseaseBn: 'ধূসর পাতার দাগ',  isHealthy: false, category: 'fungal'   },
  { idx: 2,  raw: 'Corn___Healthy',         cropEn: 'Corn',   cropBn: 'ভুট্টা',  diseaseEn: 'Healthy',            diseaseBn: 'সুস্থ',              isHealthy: true,  category: 'healthy'  },
  { idx: 3,  raw: 'Invalid',                cropEn: null,     cropBn: null,       diseaseEn: 'Invalid',            diseaseBn: 'অবৈধ ছবি',        isHealthy: false, category: 'invalid'  },
  { idx: 4,  raw: 'Potato___Early_Blight',  cropEn: 'Potato', cropBn: 'আলু',     diseaseEn: 'Early Blight',       diseaseBn: 'আগাম ঝলসা',       isHealthy: false, category: 'fungal'   },
  { idx: 5,  raw: 'Potato___Healthy',       cropEn: 'Potato', cropBn: 'আলু',     diseaseEn: 'Healthy',            diseaseBn: 'সুস্থ',              isHealthy: true,  category: 'healthy'  },
  { idx: 6,  raw: 'Potato___Late_Blight',   cropEn: 'Potato', cropBn: 'আলু',     diseaseEn: 'Late Blight',        diseaseBn: 'বিলম্বিত ঝলসা',    isHealthy: false, category: 'fungal'   },
  { idx: 7,  raw: 'Rice___Brown_Spot',      cropEn: 'Rice',   cropBn: 'ধান',     diseaseEn: 'Brown Spot',         diseaseBn: 'বাদামি দাগ',        isHealthy: false, category: 'fungal'   },
  { idx: 8,  raw: 'Rice___Healthy',         cropEn: 'Rice',   cropBn: 'ধান',     diseaseEn: 'Healthy',            diseaseBn: 'সুস্থ',              isHealthy: true,  category: 'healthy'  },
  { idx: 9,  raw: 'Rice___Leaf_Blast',      cropEn: 'Rice',   cropBn: 'ধান',     diseaseEn: 'Leaf Blast',         diseaseBn: 'পাতার ব্লাস্ট',     isHealthy: false, category: 'fungal'   },
  { idx: 10, raw: 'Wheat___Brown_Rust',     cropEn: 'Wheat',  cropBn: 'গম',      diseaseEn: 'Brown Rust',         diseaseBn: 'বাদামি মরিচা',     isHealthy: false, category: 'fungal'   },
  { idx: 11, raw: 'Wheat___Healthy',        cropEn: 'Wheat',  cropBn: 'গম',      diseaseEn: 'Healthy',            diseaseBn: 'সুস্থ',              isHealthy: true,  category: 'healthy'  },
  { idx: 12, raw: 'Wheat___Yellow_Rust',    cropEn: 'Wheat',  cropBn: 'গম',      diseaseEn: 'Yellow Rust',        diseaseBn: 'হলুদ মরিচা',       isHealthy: false, category: 'fungal'   },
];
