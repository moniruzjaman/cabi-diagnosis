...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const shareTargetInfo: Record<AppTab, {
    ...
    home: {
      ...
      titleBn: 'বালাইনাশক নির্দেশিকা — আধুনিক বালাইনাশক ও বালাই ব্যবস্থাপনা প্ল্যাটফর্ম',
    ...
    database: {
      ...
      titleBn: 'বালাইনাশক নির্দেশিকা — অনুমোদিত বালাইনাশক ডাটাবেস',
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg text-white">
                {language === 'bn' ? 'বালাইনাশক নির্দেশিকা শেয়ার করুন' : 'Share Pesticide Guide'}
              </h3>
